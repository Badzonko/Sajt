...
$(document).ready(function(){ //u paket polje kontakta forme upisuje izabrani paket i menja boju iz default sive u crnu
  $("#add").click(function(){
      ...
      //$('#pk').html('Veliki paket');
      document.getElementById("pk").value = "Reklamni website ( 99€ )";
  });
});
...
$(document).ready(function(){ //u paket polje kontakta forme upisuje izabrani paket i menja boju iz default sive u crnu
  $("#adding").click(function(){
      ...
      document.getElementById("pk").value = "Portfolio website ( 199€ )";
  });
});
$(document).ready(function(){ //u paket polje kontakta forme upisuje izabrani paket i menja boju iz default sive u crnu
  $("#added").click(function(){
      document.getElementById("pk").style.color = "black"
      //$('#pk').html('Mini paket');
      document.getElementById("pk").value = "Biznis website ( 399€ )";
  });
});
$(document).ready(function(){ //u paket polje kontakta forme upisuje izabrani paket i menja boju iz default sive u crnu
  $("#addd").click(function(){
      document.getElementById("pk").style.color = "black"
      //$('#pk').html('Mini paket');
      document.getElementById("pk").value = "E-commerce website ( 599€ )";
  });
});
$(document).ready(function(){ //u paket polje kontakta forme upisuje izabrani paket i menja boju iz default sive u crnu
  $("#addapp").click(function(){
      document.getElementById("pk").style.color = "black"
      //$('#pk').html('Mini paket');
      document.getElementById("pk").value = "Reklamna web application ( 199€ )";
  });
});
$(document).ready(function(){ //u paket polje kontakta forme upisuje izabrani paket i menja boju iz default sive u crnu
  $("#addingapp").click(function(){
      document.getElementById("pk").style.color = "black"
      //$('#pk').html('Mini paket');
      document.getElementById("pk").value = "Biznis web application ( 399€ )";
  });
});
$(document).ready(function(){ //u paket polje kontakta forme upisuje izabrani paket i menja boju iz default sive u crnu
  $("#addedapp").click(function(){
      document.getElementById("pk").style.color = "black"
      //$('#pk').html('Mini paket');
      document.getElementById("pk").value = "Media web application ( 599€ )";
  });
});
$(document).ready(function(){ //u paket polje kontakta forme upisuje izabrani paket i menja boju iz default sive u crnu
  $("#adddapp").click(function(){
      document.getElementById("pk").style.color = "black"
      //$('#pk').html('Mini paket');
      document.getElementById("pk").value = "E-commerce web application ( 799€ )";
  });
});
$(document).ready(function(){ //u paket polje kontakta forme upisuje izabrani paket i menja boju iz default sive u crnu
  $("#addcms").click(function(){
      document.getElementById("pk").style.color = "black"
      //$('#pk').html('Mini paket');
      document.getElementById("pk").value = "Reklamni cms website ( 99€ )";
  });
});
$(document).ready(function(){ //u paket polje kontakta forme upisuje izabrani paket i menja boju iz default sive u crnu
  $("#addingcms").click(function(){
      document.getElementById("pk").style.color = "black"
      //$('#pk').html('Mini paket');
      document.getElementById("pk").value = "Portfolio cms website ( 199€ )";
  });
});
$(document).ready(function(){ //u paket polje kontakta forme upisuje izabrani paket i menja boju iz default sive u crnu
  $("#addedcms").click(function(){
      document.getElementById("pk").style.color = "black"
      //$('#pk').html('Mini paket');
      document.getElementById("pk").value = "Biznis cms website ( 299€ )";
  });
});
$(document).ready(function(){ //u paket polje kontakta forme upisuje izabrani paket i menja boju iz default sive u crnu
  $("#adddcms").click(function(){
      document.getElementById("pk").style.color = "black"
      //$('#pk').html('Mini paket');
      document.getElementById("pk").value = "Media cms website ( 499€ )";
  });
});
$(document).ready(function(){ //u paket polje kontakta forme upisuje izabrani paket i menja boju iz default sive u crnu
  $("#addlogo").click(function(){
      document.getElementById("pk").style.color = "black"
      //$('#pk').html('Mini paket');
      document.getElementById("pk").value = "Logo ( 70€ )";
  });
});
$(document).ready(function(){ //u paket polje kontakta forme upisuje izabrani paket i menja boju iz default sive u crnu
  $("#addbr").click(function(){
      document.getElementById("pk").style.color = "black"
      //$('#pk').html('Mini paket');
      document.getElementById("pk").value = "Brochure ( 40€ - 100€ )";
  });
});
